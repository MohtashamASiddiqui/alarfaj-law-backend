    ...
    const fetchPersonDetails = async () => {
      try {
        const response = await fetch(
          `https://www.arfajlaw.site/api/people/read/${url}`
        );
    ...
    <div className="peoples">
      <div className="person-details">
        <div className="person-con">
          ...
          <div className="person-second-con2">
            <div>
        ...
        <div className="person-con2">
          ...
          <h3 className="people-con2-title">EDUCATION</h3>
          ...
          <h3 className="people-con2-title">ADMISSIONS</h3>
